...
if errorlevel 2 (
   ...
   goto end2
    ...
    if errorlevel 2 (
        ...
        echo Se você estiver apenas atualizando sua ROM, IGNORE ESSE AVISO.
        echo.
...
:end1
echo.
echo Parece que há algo errado. O script será encerrado. Corrija o erro e tente novamente.
echo.
pause
